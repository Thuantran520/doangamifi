...
<body>
    <div class="lesson-page-container">
        <header class="page-header">
            ...
            {{-- Sửa icon và tiêu đề cho Javascript --}}
            <h1><i class="fab fa-js-square"></i> Bài học Javascript</h1>
        </header>

        <div class="lesson-list">
            {{-- Sửa biến lặp và data-lesson-id --}}
            @forelse($javascript as $lesson)
                <div class="lesson-item accordion" data-lesson-id="javascript-{{ $lesson->lesson_id }}">
