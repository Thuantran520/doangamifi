...
<head>
    <meta charset="UTF-8">
    <title>Thêm câu hỏi Quiz C++</title>
...
<div class="container mt-4">
    <h2>Thêm câu hỏi Quiz C++</h2>
    <form id="lesson-form" method="POST" action="{{ route('admin.quizcpp.store') }}">
        @csrf
        ...
        <a href="{{ route('admin.quizcpp.index') }}" class="btn btn-secondary ms-2">Quay lại</a>
    </form>

    <hr>
    <h4>Nhập liệu bằng file Excel/CSV</h4>
    <form method="POST" action="{{ route('admin.quizcpp.upload') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
