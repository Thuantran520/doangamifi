...
<div class="container py-4">
    ...
    <a href="{{ route('admin.quizpython.edit', ['quizpython' => $quiz->id]) }}" class="btn btn-warning">Sửa</a>
    <a href="{{ route('admin.quizpython.index') }}" class="btn btn-secondary">Quay lại danh sách</a>
</div>
</body>
</html>