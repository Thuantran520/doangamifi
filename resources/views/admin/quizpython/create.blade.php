...
<div class="container mt-4">
    ...
    <form id="lesson-form" method="POST" action="{{ route('admin.quizpython.store') }}">
        @csrf
        ...
        <a href="{{ route('admin.quizpython.index') }}" class="btn btn-secondary ms-2">Quay lại</a>
    </form>

    <hr>
    <h4>Nhập liệu bằng file Excel/CSV</h4>
    <form method="POST" action="{{ route('admin.quizpython.upload') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
...
<!-- nạp script để Admintime.js điền created_at -->
