...
<div class="container py-4">
    ...
    <form id="lesson-form" action="{{ route('admin.quizpython.update', $quiz->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('admin.quizpython.index') }}" class="btn btn-secondary">Quay lại</a>
    </form>

    <form action="{{ route('admin.quizpython.destroy', $quiz->id) }}" method="POST" class="mt-4" onsubmit="return confirm('Bạn chắc chắn muốn xóa câu hỏi này?');">
        @csrf
        @method('DELETE')
