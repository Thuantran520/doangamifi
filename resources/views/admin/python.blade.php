...
<head>
  ...
  <title>Quản lý bài học Python</title>
...
<div class="admin-container">
    <div class="page-header">
        <h1><i class="fab fa-python"></i> Quản lý bài học Python</h1>
        <div>
            <a href="{{ route('admin.lesson') }}" class="back-btn" style="margin-right: 15px;"><i class="fas fa-arrow-left"></i> Quay lại</a>
            <a href="{{ route('admin.python.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Thêm bài học</a>
        </div>
    </div>
        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
                ...
                <a href="{{ route('admin.python.edit', $lesson->lesson_id) }}" class="btn btn-edit">
                  <i class="fas fa-edit"></i> Sửa
                </a>
                <form action="{{ route('admin.python.destroy', $lesson->lesson_id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
                  @csrf
                  @method('DELETE')
