...
<head>
    <meta charset="UTF-8">
    <title>Chi tiết câu hỏi Quiz JavaScript (Admin)</title>
...
<div class="container py-4">
    ...
    <a href="{{ route('admin.quizjavascript.edit', ['quizjavascript' => $quiz->id]) }}" class="btn btn-warning">Sửa</a>
    <a href="{{ route('admin.quizjavascript.index') }}" class="btn btn-secondary">Quay lại danh sách</a>
</div>
</body>
</html>