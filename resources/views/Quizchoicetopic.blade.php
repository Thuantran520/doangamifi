    ...
    <div class="row justify-content-center">
        <div class="col-md-4 col-sm-6">
            <div class="quiz-card">
                ...
                <a href="{{ route('quizpython.index') }}" class="btn-quiz">Làm bài Python</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="quiz-card">
                ...
                <a href="{{ route('quizcpp.index') }}" class="btn-quiz">Làm bài C++</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="quiz-card">
                ...
                <a href="{{ route('quizjavascript.index') }}" class="btn-quiz">Làm bài JavaScript</a>
            </div>
        </div>
    </div>
